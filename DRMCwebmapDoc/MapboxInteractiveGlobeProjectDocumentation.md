...
>- Mapbox GL JS Documentation: [found here](https://docs.mapbox.com/mapbox-gl-js/guides/)
>	client-side JavaScript library for building web maps
...
---
## What is Mapbox and How to Build a Webmap?
Mapbox is a JavaScript library. With Mapbox, you can now begin to inject interactive maps into a webpage (HTML). Without Mapbox, HTML doesn't know how to draw maps, it only provides the page structure. 

When building webmap, three tools are involved:
1. HTML: provides the structure of the website, think empty boxes
2. CSS: the layouts and appearances, e.g. font formatting
3. JavaScript (Mapbox+other code you write): the functionality, rendering the maps we want
---
...
---
## Creating a Basic Spinning Base Globe
...
Now we have a basic spinning globe and some maps that are overlaid on the spinning globe, we want to add some cool features to make the map interactive. This is where Mapbox comes in handy: it will provide tools for customizing. 
#### 1. Reset/ Spin the Globe Button
This button resets the map, and starts the spinning globe display again. 
#### 2. Transparency bar to toggle 
You could change the opacity of the maps, and compare old maps with modern map.
#### 3. Show a Location pop up for the DRMC
...
#### 4. Side bars
On the right side of the page, you will find a column of various buttons, where you could:
- Zoom in/out
- Enter full screen
- Find my location
- Change basemaps
